...
export default function NewBlueprintPage() {
  ...
  const [blueprint, setBlueprint] = useState({
    ...
    description: '',
    fields: [
      { id: crypto.randomUUID(), type: 'text', label: '', required: false, position: { x: 0, y: 0 } }
    ]
  });
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold bg-gradient-to-r from-indigo-600 to-teal-600 bg-clip-text text-transparent">New Template</h1>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Define the name and description of your blueprint</CardDescription>
            </CardHeader>
